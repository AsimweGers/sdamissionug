...
const SocialBar = () => {
  return (
    <div className="flex bg-red-800 h-10 items-center px-20 lg:px-80">
      <Link href="https://www.facebook.com/profile.php?id=100088305281566&sk=about">
      ...
      <Link href="https://www.youtube.com/@bwambalejoshua231/videos">
        <p className="footer-link">
      ...
      <Link href="https://mobile.twitter.com/uquicks">
        <p>
      ...
      <Link href="https://www.pinterest.com/search/my_pins/?q=uquicks&rs=filter">
        <p className="footer-link">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20">
      ...
      <Link href="https://www.linkedin.com/groups/12746138/">
        <p className="-mt-2">
      ...
      <Link href="https://www.instagram.com/uquicksfullgospelweb/">
        <p className="footer-link">
          <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20">
